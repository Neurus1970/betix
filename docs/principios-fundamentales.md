...
## Todo el estado del sistema es código versionado
...
## Las fronteras entre componentes son contratos estructurales, no convenciones voluntarias
...
## La plataforma se clona, no se hereda
...
## La calidad se automatiza y se enforcea — nunca se sugiere
...
## Una sola fuente de verdad — cero estado implícito
