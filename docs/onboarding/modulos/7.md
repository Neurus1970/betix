...
> **Principio 4 en acción:** una sola fuente de verdad. El estado del trabajo vive en Jira. El estado del código vive en Git. La trazabilidad entre ambos es el contrato.
...
Esto implementa el Principio 3: un estándar que se puede saltear no es un estándar.
