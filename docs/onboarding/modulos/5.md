...
graph TD
    subgraph "Disparados por push/PR a develop"
        ...
        AIR["ai-pr-review.yml\nRevisión automática con Claude\nPR a develop o main"]
    end

    subgraph "Disparados por push/PR a main"
        BLD["build.yml\nSonarCloud Quality Gate\nTodos los PRs a main"]
        REL["release.yml\nRelease Please\nPush a main"]
    end

    subgraph "Disparados por eventos de branch/PR"
        HOT["ci-hotfix.yml\nSuite completa\nBranch hotfix/**"]
        JBI["jira-branch-to-in-progress.yml\nBranch creada → Jira In Progress"]
        JCM["jira-close-on-merge.yml\nPR mergeado → Jira Done"]
    end
