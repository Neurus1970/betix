...
```mermaid
graph LR
    DOCKERFILE["Dockerfile\n(instrucciones)"] -->|docker build| IMAGE["Imagen Docker\nbetix-api:1.2.0"]
    IMAGE -->|docker run| C1["Contenedor 1\npid 1234"]
    IMAGE -->|docker run| C2["Contenedor 2\npid 5678"]
...
graph TD
    DB["db\npostgres:16-alpine\npuerto 5432"]
    SEED["db-seed\npostgres:16-alpine\ncarga seeds al iniciar"]
    REDIS["redis\nredis:7-alpine\npuerto 6379"]
    CORE["core\nbetix-core:latest\npuerto 5001->5000"]
    API["api\nbetix-api:latest\npuerto 3000->3000"]
    FRONT["frontend\nbetix-frontend:latest\npuerto 8080->80"]
