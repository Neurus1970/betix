...
graph TD
    subgraph Pirámide de tests
        E2E["Cucumber BDD<br/>features/<br/>33 escenarios / 80 steps<br/>Comportamiento de negocio desde afuera"]
        INT["Jest + Supertest<br/>tests/<br/>156 tests<br/>Integración del API Node.js"]
        UNIT["pytest<br/>core/tests/<br/>45 tests<br/>Lógica de negocio Python"]
    end
...
| [`docs/database.md`](../../database.md) | Schema PostgreSQL, seeds CSV y cómo se cargan los datos de fixture |
