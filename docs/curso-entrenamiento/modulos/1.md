...
← [Volver al temario](../temario-onboarding-training-course.md) | ← [Módulo 0](../Modulo-0.md)
...
├── data/               → Mock data (⚠️ debe sincronizarse con src/data/)
...
├── data/               → Mock data (⚠️ debe sincronizarse con core/data/)
└── VERSION             → Versión semántica independiente (ej: 1.3.0)
```

> **Trampa frecuente:** Los datos de mock existen en **dos lugares**: `src/data/` y `core/data/`. Si modificás uno, tenés que modificar el otro. Ver [CLAUDE.md — Mock data](../../../CLAUDE.md#critical) y el skill [`sync-mock-data`](../../../.claude/skills/sync-mock-data.md).
...
```
Leé el archivo core/app.py y core/routes/.
